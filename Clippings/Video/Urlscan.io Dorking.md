...
hash:{sha256}
```
- Looks for everything that uses the hash provided(e.g: 1. create a js file name hash then pass it here it will list every site using that js, 2. find a favicon hash pass it here and it will look for every )
